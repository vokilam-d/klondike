...
export class AdminBlogPostController {
  ...
  @Get(':id')
  async getBlogPost(@Param('id') blogPostId: string): Promise<ResponseDto<AdminBlogPostDto>> {
    const blogPost = await this.blogPostService.getBlogPost(blogPostId);
  ...
  async updateBlogPost(
    ...
    const updated = await this.blogPostService.updateBlogPost(blogPostId, blogPostDto);
  ...
  @Delete(':id')
  async deleteBlogPost(@Param('id') blogPostId: string): Promise<ResponseDto<AdminBlogPostDto>> {
